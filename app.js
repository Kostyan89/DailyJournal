...
const post1 = new Post({
  title: "Day 1",
  content: "Start writing my own post!",
});
const post2 = new Post({
  title: "Day 2",
  content: "Let's wright some interesting post",
});
const post3 = new Post({ title: "Day 3", content: "New cool post" });
...
app.get("/posts/:_id", async (req, res) => {
  ...
  const requestedPost = await Post.findOne({ _id: requestedPostId });
  res.render("post", {
